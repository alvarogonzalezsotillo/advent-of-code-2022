...
The code can be run with [[https://ammonite.io/][ammonite]], a script runner for Scala. I prefer ammonite over scala+sbt for the simplicity of installation and execution.
